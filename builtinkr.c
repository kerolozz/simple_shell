 ...
 * @inf: structure contain potential arguments it used to maintain
 * constant function prototype.
 * Return: exits with a given exit status that return
 ...
 * @inf: structure contain potential argument it used to maintain
 * constant function prototype.
 * Return: Always return 0
 */
